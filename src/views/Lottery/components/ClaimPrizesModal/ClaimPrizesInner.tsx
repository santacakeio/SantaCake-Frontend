...
import { Flex, Button, Text, AutoRenewIcon, PresentWonIcon } from '@santacakeio/uikit'
      ...
      if (receipt.status) {
        toastSuccess(
          ...
          <ToastDescriptionWithTx txHash={receipt.transactionHash}>
            {t('Your XCake prizes for round %lotteryId% have been sent to your wallet', { lotteryId })}
