...
import { Box, Flex, lightColors, Spinner, Text, Timeline } from '@santacakeio/uikit'
...
const PancakeSquadHeader: React.FC<PancakeSquadHeaderType> = ({
  ...
  return (
    ...
    >
      ...
      <Text color={lightColors.warning} textAlign="center" bold>
        {t('Mint Cost: %minCost% XCake each', {
      ...
      <Text color={lightColors.invertedContrast} textAlign="center">
        {t('SantaCake’s first official generative NFT collection.')}
      </Text>
