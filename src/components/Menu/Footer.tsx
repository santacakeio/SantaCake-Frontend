...
import { ButtonMenu, ButtonMenuItem, LinkExternal, Flex, Svg, Image, Button } from '@santacakeio/uikit'
  ...
  return (
    <Wrapper $isSide={isSide}>
      ...
      >
        ...
        <Image src="/images/help.png" alt="Get some help" width={80} height={80} />
      </Flex>
    </Wrapper>
  )
}
