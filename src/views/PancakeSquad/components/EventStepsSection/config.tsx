...
import { Button } from '@santacakeio/uikit'
  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active SantaCake Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold XCake'),
      bodyText: [t('Each NFT costs XCake to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
            href="https://swap.santacake.io/swap?outputCurrency=0x357159Bf925543C6E3fd965064caa9CF964f4418"
            target="_blank"
            width="100%"
          >
            {t('Buy XCake')}
