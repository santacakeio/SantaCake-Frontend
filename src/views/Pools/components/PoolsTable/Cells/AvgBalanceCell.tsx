import { Box, Flex, HelpIcon, Skeleton, Text, useMatchBreakpoints, useTooltip } from '@santacakeio/uikit'
...
const AvgBalanceCell: React.FC<AvgBalanceCellProps> = ({ pool, account, userDataLoaded }) => {
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    t(
      'Max XCake entry for both IFO sale is capped by average pool balance in this pool. This is calculated by the average block balance in the IFO pool in the past blocks prior to cut-off block.',
    ),
    { placement: 'bottom' },
  )
