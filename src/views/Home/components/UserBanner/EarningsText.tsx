...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and XCake pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and XCake pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from XCake pool', data)
  }
