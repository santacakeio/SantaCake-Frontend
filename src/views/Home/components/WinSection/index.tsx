...
import { Flex, Text, TicketFillIcon, PredictionsIcon } from '@santacakeio/uikit'
...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'XCake card' },
    { src: 'green', alt: 'Green XCake card with up arrow' },
    { src: 'red', alt: 'Red Cake card with down arrow' },
    { src: 'top-right', alt: 'XCake card' },
  ],
}
