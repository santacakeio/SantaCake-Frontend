...
import { Flex, Text, Skeleton, Button, ArrowForwardIcon } from '@santacakeio/uikit'
...
const LotteryCardContent = () => {
  ...
  const cakePrizesText = t('%cakePrizeInUsd% in XCake prizes this round', { cakePrizeInUsd: cakePriceBusdAsString })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="white" mb="40px">
          {t('Buy tickets with XCake, win XCake if your numbers match')}
        </Text>
      </Flex>
