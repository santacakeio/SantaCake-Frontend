...
import { Text, useMatchBreakpoints, TokenPairImage as UITokenPairImage } from '@santacakeio/uikit'
...
const NameCell: React.FC<NameCellProps> = ({ pool }) => {
  ...
  if (vaultKey) {
    ...
    title = t('Manual XCake')
    subtitle = `${t('Earn')} XCake ${t('Stake').toLocaleLowerCase()} XCake`
  }
